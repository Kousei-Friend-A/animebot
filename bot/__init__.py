...
class Var:
    ...
    FFCODE_1080 = """ffmpeg -i '{}' -progress '{}' -preset ultrafast -c:v libx264 -s 1920x1080 -pix_fmt yuv420p -crf 30 -c:a libopus -b:a 32k -c:s copy -map 0 -ac 2 -vbr 2 -level 3.1 '{}' -y"""
    FFCODE_720 = """ffmpeg -i '{}' -progress '{}' -preset ultrafast -c:v libx264 -s 1280x720 -pix_fmt yuv420p -crf 30 -c:a libopus -b:a 32k -c:s copy -map 0 -ac 2 -vbr 2 -level 3.1 '{}' -y"""
    FFCODE_480 = """ffmpeg -i '{}' -progress '{}' -preset ultrafast -c:v libx264 -s 640x480 -pix_fmt yuv420p -crf 30 -c:a libopus -b:a 32k -c:s copy -map 0 -ac 2 -vbr 2 -level 3.1 '{}' -y"""
